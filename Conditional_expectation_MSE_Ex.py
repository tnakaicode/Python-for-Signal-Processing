...
print(160 / 3., np.dot(x[:, x.sum(axis=0) == 2].T,
                       np.array([10, 20, 50])).mean())
...
J = S.summation((xi - h)**2 * S.Rational(1, 8),
                (X10, 0, 1), (X20, 0, 1), (X50, 0, 1))
...
# np.random.random samples for 3 coins tossed
x = np.random.randint(0, 2, (3, 5000))
eta = np.dot(x[:2, :].T, np.array([10, 20]))  # sum of 10p and 20p

print(np.dot(x[:, eta == 0].T, np.array(
    [10, 20, 50])).mean())  # E(xi|eta=0)
# E(xi|eta=10)
print(np.dot(x[:, eta == 10].T, np.array([10, 20, 50])).mean())
# E(xi|eta=20)
print(np.dot(x[:, eta == 20].T, np.array([10, 20, 50])).mean())
# E(xi|eta=30)
print(np.dot(x[:, eta == 30].T, np.array([10, 20, 50])).mean())
...
eta = S.Piecewise((1, S.And(S.Gt(x, 0), S.Lt(x, S.Rational(1, 3)))),  # 0 < x < 1/3
                  (2, S.And(S.Gt(x, S.Rational(1, 3)), S.Lt(
                      x, S.Rational(2, 3)))),  # 1/3 < x < 2/3,
...
f, ax = plt.subplots()
ax.hist(2 * x**2, bins=np.array([0, 1 / 3.,
                                 2 / 3., 1])**2 * 2, normed=True, alpha=.5)
